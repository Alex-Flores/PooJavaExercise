...
public class AlumnoJpaController implements Serializable {
    ...
    /*
        5° creamos la Entity Manager Factory, luego cambiamos el nombre a la variable emf y lo reemplazamos con "schoolJPAPU" que esta "persistence.xml"
    */
    public AlumnoJpaController(){
        emf = Persistence.createEntityManagerFactory("schoolJPAPU");
    }
